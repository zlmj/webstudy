//当前登录用户
var currentUser = { "userName": "向中燕", "photo": "../resource/image/user1.jpg" };
...
function createSendedMsg(msg) {
    ...
    item.innerHTML = createMsgHtml(msg, currentUser.userName, currentUser.photo, time);
    return item;
}
...
function loadHistoryData(historyMsg) {
    ...
    for (var msgItem of historyMsg) {
        ...
        if (msgItem.userName == currentUser.userName) {
